...
const PILLARS: PillarConfig[] = [
  ...
  },
  {
    ...
    animation: "ratings",
    fallbackTitle: "Zufriedenheit auf beiden Seiten",
    fallbackDesc:
      "Keine Warteschleife, klare Antworten — und Buchungen, die wirklich ankommen.",
  },
];
...
const DEFAULT_TAGS: TagConfig[] = [
  ...
  { label: "#Tischreservierung", desc: "Frei prüfen und verbindlich buchen", cardClass: TAG_CARD_CLASSES[0] },
  { label: "#Bestellungen", desc: "Orders aufnehmen und abschließen", cardClass: TAG_CARD_CLASSES[1] },
  { label: "#Lieferstatus", desc: "Wo bleibt meine Bestellung?", cardClass: TAG_CARD_CLASSES[2] },
  { label: "#Terminbuchung", desc: "Verfügbarkeit prüfen und eintragen", cardClass: TAG_CARD_CLASSES[3] },
  { label: "#Umbuchen", desc: "Termine verschieben oder absagen", cardClass: TAG_CARD_CLASSES[4] },
  { label: "#FAQ", desc: "Öffnungszeiten, Preise, Leistungen", cardClass: TAG_CARD_CLASSES[5] },
  { label: "#MenüAuskunft", desc: "Gerichte, Allergene, Empfehlungen", cardClass: TAG_CARD_CLASSES[0] },
  { label: "#Zimmerstatus", desc: "Verfügbarkeit und Zimmertypen", cardClass: TAG_CARD_CLASSES[1] },
  { label: "#CheckInInfo", desc: "Anreise, Parken, Wi-Fi", cardClass: TAG_CARD_CLASSES[2] },
  { label: "#SpaTermine", desc: "Behandlungen und Slots vergeben", cardClass: TAG_CARD_CLASSES[3] },
  { label: "#PraxisTriage", desc: "Anliegen klären, passenden Slot finden", cardClass: TAG_CARD_CLASSES[4] },
  { label: "#KanzleiEingang", desc: "Anfragen vorsortieren und erfassen", cardClass: TAG_CARD_CLASSES[5] },
  { label: "#Bestätigungen", desc: "SMS oder E-Mail nach dem Gespräch", cardClass: TAG_CARD_CLASSES[0] },
  { label: "#Erinnerungen", desc: "No-Shows reduzieren", cardClass: TAG_CARD_CLASSES[1] },
  { label: "#AnrufZusammenfassung", desc: "Kurzprotokoll für Ihr Team", cardClass: TAG_CARD_CLASSES[2] },
  { label: "#Weiterleitung", desc: "Bei Bedarf an einen Menschen", cardClass: TAG_CARD_CLASSES[3] },
  { label: "#Rückruf", desc: "Callback-Wunsch aufnehmen", cardClass: TAG_CARD_CLASSES[4] },
  { label: "#ParalleleAnrufe", desc: "Mehrere Gespräche gleichzeitig", cardClass: TAG_CARD_CLASSES[5] },
  { label: "#NatürlicheStimme", desc: "Klingt menschlich, antwortet klar", cardClass: TAG_CARD_CLASSES[0] },
  { label: "#Wissensbasis", desc: "Antwortet mit Ihren aktuellen Daten", cardClass: TAG_CARD_CLASSES[1] },
  { label: "#Recherche", desc: "Infos finden und Aufgaben erledigen", cardClass: TAG_CARD_CLASSES[2] },
  { label: "#Upselling", desc: "Extras und Upgrades anbieten", cardClass: TAG_CARD_CLASSES[3] },
  { label: "#Beschwerden", desc: "Ruhig aufnehmen und eskalieren", cardClass: TAG_CARD_CLASSES[4] },
  { label: "#Anfahrt", desc: "Adresse und Wegbeschreibung", cardClass: TAG_CARD_CLASSES[5] },
  { label: "#Stornoregeln", desc: "Konditionen verständlich erklären", cardClass: TAG_CARD_CLASSES[0] },
  { label: "#MultiStandort", desc: "Filialen und Nummern zuordnen", cardClass: TAG_CARD_CLASSES[1] },
  { label: "#CRMSync", desc: "Kontakte und Vorgänge synchron", cardClass: TAG_CARD_CLASSES[2] },
  { label: "#WhatsApp", desc: "Auch per Messaging erreichbar", cardClass: TAG_CARD_CLASSES[3] },
  { label: "#EMailKanal", desc: "Ein Assistent, mehrere Kanäle", cardClass: TAG_CARD_CLASSES[4] },
  { label: "#SpamFilter", desc: "Werbeanrufe aussortieren", cardClass: TAG_CARD_CLASSES[5] },
  { label: "#VoicemailErsatz", desc: "Kein Band — echte Gespräche", cardClass: TAG_CARD_CLASSES[0] },
  { label: "#FollowUp", desc: "Offene Punkte nachverfolgen", cardClass: TAG_CARD_CLASSES[1] },
  { label: "#ZahlungsInfo", desc: "Preise, Anzahlung, Rechnung", cardClass: TAG_CARD_CLASSES[2] },
  { label: "#TeamEntlastung", desc: "Telefonstress vom Personal nehmen", cardClass: TAG_CARD_CLASSES[3] },
];
